...
RSpec.describe "User Show Page", type: :feature do
  before :each do 
    VCR.use_cassette("top_rated_movies_dashboard") do
      ...
      @andra = User.create!(name: "Andra", email: "andra@turing.edu", password: "heyo888") 
      @hady = User.create!(name: "Hady", email: "hady@turing.edu", password: "heyo888") 
      @mike = User.create!(name: "Mike", email: "mky@turing.edu", password: "heyo888") 
      @malena = User.create!(name: "Malena", email: "malena@tours.edu", password: "heyo888") 
